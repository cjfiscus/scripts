...
-
kmeroutput.py
Python3 script that parses the "best K" from Kmergenie html output files and writes them to an output file.  This script also calculates mean, median and mode of best K and writes to stout.
-
ortho.py
