...
run_pipeline.pl -fork1 -h SNP_all_lines.hmp.txt -fork2 -importGuess phenotype.txt -fork3 -q qmatrix_3.txt -fork4 -k kinship.txt -combine5 -input1 -input2 -input3 -intersect -combine6 -input5 -input4 -mlm -export mlm_output_3 -runfork1 -runfork2 -runfork3 -runfork4
